...
// Cook the pasta according to the package directions, drain, toss with a bit of oil to prevent sticking, and set aside. 2. Heat the oil in a saut pan over medium heat. Add the onions and saut for 3 minutes. 3. Add the garlic, bell peppers, zucchini, and salt, and saut 2 minutes, until all the veggies are soft. 4. Add the cooked pasta to the veggies and toss to combine. 5. Pour the whisked eggs and the parmesan over the veggies, reduce the heat to low and cook, stirring constantly and scraping the egg off the bottom of the pan, until the eggs are cooked through, about 3-5 minutes. Transfer to a plate and serve."
